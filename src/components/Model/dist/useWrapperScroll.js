    ...
    react_1.useEffect(function () {
        if (wrapperRef.current) {
            var updateScrollValue_1 = function () {
                if (wrapperRef.current) {
                    var _a = wrapperRef.current, scrollTop = _a.scrollTop, scrollHeight = _a.scrollHeight, offsetHeight = _a.offsetHeight;
            ...
            return function () { var _a; return (_a = wrapperRef === null || wrapperRef === void 0 ? void 0 : wrapperRef.current) === null || _a === void 0 ? void 0 : _a.removeEventListener('scroll', updateScrollValue_1); };
        }
